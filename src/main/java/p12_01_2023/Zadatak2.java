...
//    (adresa) po ceni od (cena nekretnin) pri cemu je kupac u obavezi da agenciji isplati novcanu vrednost u iznosu
//    od (zarada agencije)

        FizickoLice prodavac = new FizickoLice("Marko Markovic", "099876796", "1202998956678");
        FizickoLice kupac = new FizickoLice("Nikoleta Vdovenko", "01266543", "2601995878655");

        Ugovor ugovor1 = new Ugovor("12.01.2022.", prodavac, kupac, 120000, "Milana Blagojevica 1, Nis");
        ugovor1.print();
